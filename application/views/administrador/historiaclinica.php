...
<div class="tab-content" id="myTabContent">
  ...
  <div class="container mt-3">
                      <div class="row">
                          <div class="col-md-12">
                            <div class="row">
                              <div class="col-md-4">
                                <h6>Historia <li title="Especialidad Ginecologia" class="fas fa-plus-circle  text-danger" data-bs-toggle="modal" href="#Agregarhistoria" role="button"></li>  <li title="Especialidad Medicina General" class="fas fa-plus-circle text-primary" data-bs-toggle="modal" href="#Agregarhistoria2" role="button"></li></h6>
  ...
  <div class="container mt-3">
                      <div class="row">
                          <div class="col-md-12">
                              <h6>Receta Medica <li title="Agregar" class="fas fa-plus-circle  text-dark" data-bs-toggle="modal" href="#ecografiamama" role="button"></li> </h6>
                              <table class="table align-items-center">
                                <thead class="thead-light">
                                  <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-12">Opciones</th>
                  ...
                  <tr>
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                          <img src="<?php echo base_url();?>public/img/theme/logo.png" width="35px;" class="img-fluid">
                        </div>
                        <div class="ms-4">
                          <p class="text-xs font-weight-bold mb-0">Doctor</p>
                          <h6 class="text-sm mb-0">Felix Diaz</h6>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                        <p class="text-xs font-weight-bold mb-0">Especialidad</p>
                        <h6 class="text-sm mb-0">Ginecologia</h6>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                        <p class="text-xs font-weight-bold mb-0">Fecha</p>
                        <h6 class="text-sm mb-0">26-12-2022</h6>
                      </div>
                    </td>
                    <td class="align-middle text-sm">
                      <div class="col text-center">
                        <p class="text-xs font-weight-bold mb-0">Hora</p>
                        <h6 class="text-sm mb-0">3:30 pm</h6>
                      </div>
                    </td>
                  </tr>
