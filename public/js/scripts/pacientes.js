    ...
    var responsable = $("input:radio[name=responsable]").change(function(){
     ...
     $("#fecha_nacimiento").on("blur",function() {
         ...
         const anios = (fechas - cumpleanios) / 3.154e+10
     ...
     $("#dni").on("blur", function () {
         var dni =  $("#dni").val(),
         url2 = "https://apiperu.dev/api/dni/" + dni + "?api_token=" + "e02a95cc4b8e0d521d447c0786af76cdb424b6a2ba25aea9f7cd9e9bc4712e86";
         $.ajax({
            url: url2,
            method: "GET",
     ...
     $("#documento").on("blur", function () {
      ...
      url3 = "https://apiperu.dev/api/dni/" + documento + "?api_token=" + "e02a95cc4b8e0d521d447c0786af76cdb424b6a2ba25aea9f7cd9e9bc4712e86";
      $.ajax({
         url: url3,
         method: "GET",
         success: function(data) {
            $("#responsable").val(data.data.nombres + " " + data.data.apellido_paterno + " " + data.data.apellido_materno );   
         } 
      });
  });
